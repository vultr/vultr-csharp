...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Os : IValidatableObject
    {
        ...
        /// <param name="name">The Operating System description..</param>
        /// <param name="arch">The Operating System architecture..</param>
        /// <param name="family">The Operating System family. .</param>
        public Os(int id = default(int), string name = default(string), string arch = default(string), string family = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.Arch = arch;
        ...
        /// </summary>
        /// <value>The Operating System family. </value>
