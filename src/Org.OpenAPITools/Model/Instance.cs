...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Instance : IValidatableObject
    {
        ...
        /// <param name="status">The current status.  * active * pending * suspended * resizing.</param>
        /// <param name="powerStatus">The power-on status.  * running * stopped.</param>
        /// <param name="serverStatus">The server health status.  * none * locked * installingbooting * ok.</param>
        /// <param name="allowedBandwidth">Monthly bandwidth quota in GB..</param>
        /// <param name="netmaskV4">The IPv4 netmask in dot-decimal notation..</param>
        /// <param name="gatewayV4">The gateway IP address..</param>
        /// <param name="v6Networks">An array of IPv6 objects..</param>
        /// <param name="hostname">The hostname for this instance..</param>
        ...
        /// <param name="internalIp">The internal IP used by this instance, if set. Only relevant when a VPC is attached..</param>
        /// <param name="kvm">HTTPS link to the Vultr noVNC Web Console..</param>
        /// <param name="osId">The [Operating System id](#operation/list-os) used by this instance..</param>
        /// <param name="appId">The [Application id](#operation/list-applications) used by this instance..</param>
        /// <param name="imageId">The [Application image_id](#operation/list-applications) used by this instance..</param>
        /// <param name="firewallGroupId">The [Firewall Group id](#operation/list-firewall-groups) linked to this Instance..</param>
        /// <param name="features">\&quot;auto_backups\&quot;, \&quot;ipv6\&quot;, \&quot;ddos_protection\&quot;.</param>
        /// <param name="plan">A unique ID for the Plan..</param>
        /// <param name="tags">Tags to apply to the instance..</param>
        /// <param name="userScheme">The user scheme.  * root * limited.</param>
        public Instance(string id = default(string), string os = default(string), int ram = default(int), int disk = default(int), string mainIp = default(string), int vcpuCount = default(int), string region = default(string), string defaultPassword = default(string), string dateCreated = default(string), string status = default(string), string powerStatus = default(string), string serverStatus = default(string), int allowedBandwidth = default(int), string netmaskV4 = default(string), string gatewayV4 = default(string), List<InstanceV6NetworksInner> v6Networks = default(List<InstanceV6NetworksInner>), string hostname = default(string), string label = default(string), string tag = default(string), string internalIp = default(string), string kvm = default(string), int osId = default(int), int appId = default(int), string imageId = default(string), string firewallGroupId = default(string), List<string> features = default(List<string>), string plan = default(string), List<string> tags = default(List<string>), string userScheme = default(string))
        {
            this.Id = id;
            this.Os = os;
            this.Ram = ram;
        ...
        /// </summary>
        /// <value>A unique ID for the VPS Instance.</value>
        ...
        /// </summary>
        /// <value>The size of the disk in GB.</value>
        ...
        /// </summary>
        /// <value>The current status.  * active * pending * suspended * resizing</value>
        ...
        /// </summary>
        /// <value>The power-on status.  * running * stopped</value>
        [DataMember(Name = "power_status", EmitDefaultValue = false)]
        public string PowerStatus { get; set; }

        /// <summary>
        /// The server health status.  * none * locked * installingbooting * ok
        /// </summary>
        /// <value>The server health status.  * none * locked * installingbooting * ok</value>
        ...
        /// </summary>
        /// <value>Monthly bandwidth quota in GB.</value>
        [DataMember(Name = "allowed_bandwidth", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>An array of IPv6 objects.</value>
        [DataMember(Name = "v6_networks", EmitDefaultValue = false)]
        public List<InstanceV6NetworksInner> V6Networks { get; set; }

        /// <summary>
        /// The hostname for this instance.
        /// </summary>
        /// <value>The hostname for this instance.</value>
        ...
        /// </summary>
        /// <value>The internal IP used by this instance, if set. Only relevant when a VPC is attached.</value>
        [DataMember(Name = "internal_ip", EmitDefaultValue = false)]
        public string InternalIp { get; set; }

        /// <summary>
        /// HTTPS link to the Vultr noVNC Web Console.
        /// </summary>
        /// <value>HTTPS link to the Vultr noVNC Web Console.</value>
        ...
        /// </summary>
        /// <value>The [Operating System id](#operation/list-os) used by this instance.</value>
        ...
        /// </summary>
        /// <value>The [Application id](#operation/list-applications) used by this instance.</value>
        ...
        /// </summary>
        /// <value>The [Application image_id](#operation/list-applications) used by this instance.</value>
        ...
        /// </summary>
        /// <value>The [Firewall Group id](#operation/list-firewall-groups) linked to this Instance.</value>
        ...
        /// </summary>
        /// <value>\&quot;auto_backups\&quot;, \&quot;ipv6\&quot;, \&quot;ddos_protection\&quot;</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AllowedBandwidth: ").Append(AllowedBandwidth).Append("\n");
            sb.Append("  NetmaskV4: ").Append(NetmaskV4).Append("\n");
            sb.Append("  GatewayV4: ").Append(GatewayV4).Append("\n");
            sb.Append("  V6Networks: ").Append(V6Networks).Append("\n");
