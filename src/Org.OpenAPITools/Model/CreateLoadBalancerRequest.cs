...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "create_load_balancer_request")]
    public partial class CreateLoadBalancerRequest : IValidatableObject
    {
        ...
        protected CreateLoadBalancerRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateLoadBalancerRequest" /> class.
        /// </summary>
        /// <param name="region">The [Region id](#operation/list-regions) to create this Load Balancer. (required).</param>
        ...
        /// <param name="label">Label for your Load Balancer..</param>
        /// <param name="instances">An array of instances IDs that you want attached to the load balancer..</param>
        ...
        public CreateLoadBalancerRequest(string region = default(string), string balancingAlgorithm = default(string), bool sslRedirect = default(bool), bool http2 = default(bool), int nodes = default(int), bool proxyProtocol = default(bool), CreateLoadBalancerRequestHealthCheck healthCheck = default(CreateLoadBalancerRequestHealthCheck), List<CreateLoadBalancerRequestForwardingRulesInner> forwardingRules = default(List<CreateLoadBalancerRequestForwardingRulesInner>), CreateLoadBalancerRequestStickySession stickySession = default(CreateLoadBalancerRequestStickySession), CreateLoadBalancerRequestSsl ssl = default(CreateLoadBalancerRequestSsl), string label = default(string), List<string> instances = default(List<string>), List<CreateLoadBalancerRequestFirewallRulesInner> firewallRules = default(List<CreateLoadBalancerRequestFirewallRulesInner>), string privateNetwork = default(string), string vpc = default(string))
        {
            // to ensure "region" is required (not null)
            if (region == null)
            {
                throw new ArgumentNullException("region is a required property for CreateLoadBalancerRequest and cannot be null");
            }
            this.Region = region;
        ...
        /// </summary>
        /// <value>The [Region id](#operation/list-regions) to create this Load Balancer.</value>
        ...
        public CreateLoadBalancerRequestHealthCheck HealthCheck { get; set; }
        ...
        /// </summary>
        /// <value>Label for your Load Balancer.</value>
        ...
        /// </summary>
        /// <value>An array of instances IDs that you want attached to the load balancer.</value>
