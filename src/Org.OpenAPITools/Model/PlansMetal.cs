...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "plans-metal")]
    public partial class PlansMetal : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlansMetal" /> class.
        /// </summary>
        /// <param name="id">A unique ID for the Bare Metal Plan..</param>
        /// <param name="cpuCount">The number of CPUs in this Plan..</param>
        /// <param name="cpuModel">The CPU model type for this instance..</param>
        /// <param name="cpuThreads">The numner of supported threads for this instance..</param>
        ...
        /// <param name="type">The plan type.  * SSD.</param>
        ...
        public PlansMetal(string id = default(string), int cpuCount = default(int), string cpuModel = default(string), int cpuThreads = default(int), int ram = default(int), string disk = default(string), int bandwidth = default(int), List<string> locations = default(List<string>), string type = default(string), int monthlyCost = default(int), int diskCount = default(int))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>A unique ID for the Bare Metal Plan.</value>
        ...
        /// </summary>
        /// <value>The number of CPUs in this Plan.</value>
        ...
        /// </summary>
        /// <value>The CPU model type for this instance.</value>
        ...
        /// </summary>
        /// <value>The numner of supported threads for this instance.</value>
        [DataMember(Name = "cpu_threads", EmitDefaultValue = false)]
