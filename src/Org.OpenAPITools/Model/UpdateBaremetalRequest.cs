...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "update_baremetal_request")]
    public partial class UpdateBaremetalRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateBaremetalRequest" /> class.
        /// </summary>
        ...
        /// <param name="osId">If supplied, reinstall the instance using this [Operating System id](#operation/list-os)..</param>
        /// <param name="appId">If supplied, reinstall the instance using this [Application id](#operation/list-applications)..</param>
        /// <param name="imageId">If supplied, reinstall the instance using this [Application image_id](#operation/list-applications)..</param>
        ...
        public UpdateBaremetalRequest(string userData = default(string), string label = default(string), string tag = default(string), int osId = default(int), int appId = default(int), string imageId = default(string), bool enableIpv6 = default(bool), List<string> attachVpc2 = default(List<string>), List<string> detachVpc2 = default(List<string>), bool enableVpc2 = default(bool), List<string> tags = default(List<string>), string userScheme = default(string))
        {
        ...
        /// </summary>
        /// <value>If supplied, reinstall the instance using this [Operating System id](#operation/list-os).</value>
        ...
        /// </summary>
        /// <value>If supplied, reinstall the instance using this [Application id](#operation/list-applications).</value>
        ...
        /// </summary>
        /// <value>If supplied, reinstall the instance using this [Application image_id](#operation/list-applications).</value>
