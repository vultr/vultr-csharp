...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "create_database_request")]
    public partial class CreateDatabaseRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDatabaseRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateDatabaseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDatabaseRequest" /> class.
        /// </summary>
        /// <param name="databaseEngine">The database engine type for the Managed Database. * &#x60;mysql&#x60; * &#x60;pg&#x60; * &#x60;ferretpg&#x60; * &#x60;redis&#x60; (required).</param>
        /// <param name="databaseEngineVersion">The version of the chosen database engine type for the Managed Database. * MySQL: &#x60;8&#x60; * PostgreSQL: &#x60;12&#x60; - &#x60;15&#x60; * FerretDB + PostgreSQL: &#x60;12&#x60; - &#x60;15&#x60; * Redis: &#x60;7&#x60; (required).</param>
        /// <param name="region">The [Region id](#operation/list-regions) where the Managed Database is located. (required).</param>
        /// <param name="plan">The [Plan id](#operation/list-database-plans) to use when deploying this Managed Database. (required).</param>
        /// <param name="label">A user-supplied label for this Managed Database. (required).</param>
        /// <param name="tag">The user-supplied tag for this Managed Database..</param>
        /// <param name="vpcId">The [VPC id](#operation/list-vpcs) to use when deploying this Managed Database. It can also be set to &#x60;new&#x60; to configure a new VPC network with this deployment..</param>
        ...
        public CreateDatabaseRequest(string databaseEngine = default(string), string databaseEngineVersion = default(string), string region = default(string), string plan = default(string), string label = default(string), string tag = default(string), string vpcId = default(string), string maintenanceDow = default(string), string maintenanceTime = default(string), List<string> trustedIps = default(List<string>), List<string> mysqlSqlModes = default(List<string>), bool mysqlRequirePrimaryKey = default(bool), bool mysqlSlowQueryLog = default(bool), int mysqlLongQueryTime = default(int), string redisEvictionPolicy = default(string))
        {
            // to ensure "databaseEngine" is required (not null)
            if (databaseEngine == null)
            {
                throw new ArgumentNullException("databaseEngine is a required property for CreateDatabaseRequest and cannot be null");
            }
            this.DatabaseEngine = databaseEngine;
            // to ensure "databaseEngineVersion" is required (not null)
            if (databaseEngineVersion == null)
            {
                throw new ArgumentNullException("databaseEngineVersion is a required property for CreateDatabaseRequest and cannot be null");
            }
            this.DatabaseEngineVersion = databaseEngineVersion;
            // to ensure "region" is required (not null)
            if (region == null)
            {
                throw new ArgumentNullException("region is a required property for CreateDatabaseRequest and cannot be null");
            }
            this.Region = region;
            // to ensure "plan" is required (not null)
            if (plan == null)
            {
                throw new ArgumentNullException("plan is a required property for CreateDatabaseRequest and cannot be null");
            }
            this.Plan = plan;
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for CreateDatabaseRequest and cannot be null");
            }
            this.Label = label;
            this.Tag = tag;
            this.VpcId = vpcId;
        ...
        /// </summary>
        /// <value>The database engine type for the Managed Database. * &#x60;mysql&#x60; * &#x60;pg&#x60; * &#x60;ferretpg&#x60; * &#x60;redis&#x60;</value>
        [DataMember(Name = "database_engine", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The version of the chosen database engine type for the Managed Database. * MySQL: &#x60;8&#x60; * PostgreSQL: &#x60;12&#x60; - &#x60;15&#x60; * FerretDB + PostgreSQL: &#x60;12&#x60; - &#x60;15&#x60; * Redis: &#x60;7&#x60;</value>
        [DataMember(Name = "database_engine_version", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>The [Plan id](#operation/list-database-plans) to use when deploying this Managed Database.</value>
        ...
        /// </summary>
        /// <value>The [VPC id](#operation/list-vpcs) to use when deploying this Managed Database. It can also be set to &#x60;new&#x60; to configure a new VPC network with this deployment.</value>
