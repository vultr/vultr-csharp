...
namespace Org.OpenAPITools.Test.Api
{
    ...
    public class BillingApiTests : IDisposable
    {
        ...
        public void GetInvoiceItemsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string invoiceId = null;
            //var response = instance.GetInvoiceItems(invoiceId);
            //Assert.IsType<GetInvoiceItems200Response>(response);
        }

        /// <summary>
        /// Test ListBillingHistory
        /// </summary>
        [Fact]
        public void ListBillingHistoryTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ListBillingHistory();
            //Assert.IsType<ListBillingHistory200Response>(response);
        }
